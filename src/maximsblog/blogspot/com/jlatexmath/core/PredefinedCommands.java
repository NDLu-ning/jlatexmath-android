...
final class PredefinedCommands {
	...
	static {
		...
		MacroInfo.Commands
				.put("includegraphics", new PredefMacroInfo(11, 1, 1));
		...
		MacroInfo.Commands
				.put("overleftrightarrow", new PredefMacroInfo(81, 1));
		...
		MacroInfo.Commands.put("underleftrightarrow",
				new PredefMacroInfo(84, 1));
		...
		MacroInfo.Commands
				.put("scriptscriptstyle", new PredefMacroInfo(165, 0));
